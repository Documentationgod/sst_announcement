...
const AttachmentList: React.FC<AttachmentListProps> = ({ attachments, className = '', url }) => {
      ...
      {images.length > 0 && (
        <div className="space-y-2">
          <div className="flex items-center gap-2 pb-2 border-b border-gray-700/50">
            ...
            <h4 className="text-sm font-bold text-purple-400 uppercase tracking-wide">Images ({images.length})</h4>
          </div>
            ...
            {images.map((image) => (
              <div key={image.id} className="relative group">
                ...
                <a
                  ...
                  className="absolute bottom-2 right-2 p-1.5 rounded-full bg-black/50 hover:bg-black/70 opacity-0 group-hover:opacity-100 transition-opacity z-10"
                  title="Download"
                >
                  <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {documents.length > 0 && (
        <div className="space-y-2">
          <div className="flex items-center gap-2 pb-2 border-b border-gray-700/50">
            ...
            <h4 className="text-sm font-bold text-blue-400 uppercase tracking-wide">Documents ({documents.length})</h4>
          </div>
          <div className="space-y-2">
            {documents.map((doc) => (
              <div key={doc.id} className="relative group">
                ...
                <a
                  ...
                  onClick={(e) => e.stopPropagation()}
                  className="absolute right-3 top-1/2 -translate-y-1/2 p-2 rounded-lg bg-gray-700/50 hover:bg-gray-700 opacity-0 group-hover:opacity-100 transition-opacity mr-20"
                  title="Download"
                >
      ...
      {url && (
        <div className="space-y-2">
          <div className="flex items-center gap-2 pb-2 border-b border-gray-700/50">
            ...
            <h4 className="text-sm font-bold text-cyan-400 uppercase tracking-wide">Link</h4>
          </div>
          <div className="relative group">
            ...
            >
              ...
              <div className="flex-shrink-0 flex items-center gap-3">
                <span className="text-xs text-gray-500 group-hover:text-blue-400">Open</span>
                <svg className="w-5 h-5 text-gray-500 group-hover:text-blue-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
